...
formApp.controller('formController', function($scope,$Country,$http,$state) {
	...
	/**
	 * check email in backed  if it is exits return userDetail
	 */
	...
	/**
	 * Update User Information Except EmailId
	 */
	...
	/**
	 * confirm paymentBy Payment Gateway and update status 
	 */
	...
	/**
	 * Make payment Request and also set Payment Stauus 0 
	 */
